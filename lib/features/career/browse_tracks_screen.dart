...
class BrowseTracksScreen extends StatefulWidget {
  ...
  const BrowseTracksScreen({super.key, this.onTrackSelected});
...
class _BrowseTracksScreenState extends State<BrowseTracksScreen> {
  ...
  Future<void> _loadTracks() async {
    try {
      ...
      try {
        ...
        debugPrint(
          'BrowseTracksScreen: backend failed ($networkError), trying local asset',
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text(l10n.browseTracks)),
      body: Column(
        children: [
          // ── Search bar ──────────────────────────────────────────────────
          Padding(
