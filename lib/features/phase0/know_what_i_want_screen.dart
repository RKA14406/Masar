...
class KnowWhatIWantScreen extends StatefulWidget {
  ...
  const KnowWhatIWantScreen({super.key, required this.userInput});
...
class _KnowWhatIWantScreenState extends State<KnowWhatIWantScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l10n.iKnowWhatIWant)),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(l10n.youCanEdit, style: theme.textTheme.bodySmall),
                  ],
                ),
              ),
              ...
              /// 🔹 Input
              AppTextField(controller: _controller, hint: l10n.aiInputHint),
