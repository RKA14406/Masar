...
import '../../features/cv_generator/cv_preview_screen.dart';
import '../../features/cv_generator/cv_storage_service.dart';
            ...
            DrawerItem(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const SevenSabakHubScreen(),
                  ),
                );
              },
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // ── Logo ────────────────────────────────────────────────────
          Center(child: AppLogo(height: 68)),
